...
public class FloatingActionsMenu extends ViewGroup {
  ...
  private static  float COLLAPSED_PLUS_ROTATION = 0f;
  private static  float EXPANDED_PLUS_ROTATION = 90f;
  ...
  private int drawableResources = R.drawable.setting;
  public void setDrawableResources(int drawableResources){
    this.drawableResources = drawableResources;
  }

  public void setCollRotation(float collRotation){
    COLLAPSED_PLUS_ROTATION = collRotation;
  }
  public void setExpandRotation(float rotation){
    EXPANDED_PLUS_ROTATION = rotation;
  }
  ...
  private void createAddButton(final Context context) {
    mAddButton = new AddFloatingActionButton(context) {
      ...
      Drawable getIconDrawable() {
        final RotatingDrawable rotatingDrawable = new RotatingDrawable(ContextCompat.getDrawable(getContext(),drawableResources));
